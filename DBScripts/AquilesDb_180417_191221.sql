...
-- User_Schedule [rel4]
alter table "public"."user"  add column  "schedule_oid"  int4;
alter table "public"."user"   add constraint fk_user_schedule foreign key ("schedule_oid") references "public"."schedule" ("oid");


-- Schedule_User [rel5]
alter table "public"."schedule"  add column  "user_oid"  int4;
alter table "public"."schedule"   add constraint fk_schedule_user foreign key ("user_oid") references "public"."user" ("oid");
